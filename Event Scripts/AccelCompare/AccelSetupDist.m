function [] = AccelSetupDist(data)
    ...
    plot(dist,data.GPSSpeed,c_line,'DisplayName',legendVal); 
    legendVal = strcat('Drive Speed',': ',string(t));
    plot(dist,data.DriveSpeed,c_dotline,'DisplayName',legendVal)
    ...
    plot(dist,slip,c_line,'DisplayName',legendVal); grid on;
    ...
    plot(dist,data.EngineRPM,c_line,'DisplayName',legendVal); grid on; hold on;
    legendVal = strcat('RPM Limit',': ',string(t));
    plot(dist,data.LaunchAimRPM,c_dotline,'DisplayName',legendVal);
    ...
    plot(dist,gLongf,c_line,'DisplayName',legendVal);
    legendVal = strcat('Raw GLong',': ',string(t));
    plot(dist,gLong,c_dot,'MarkerSize',1,'DisplayName',legendVal); 
    grid on;
    ...
    plot(dist,heave,c_line,'DisplayName',legendVal); 
    ...
    plot(dist,pitch,c_line,'DisplayName',legendVal);
    ...
    plot(dist,SuspPosFL,c_line,'MarkerSize',3,'DisplayName',legendVal); 
    legendVal = strcat('Filtered',': ',string(t));
    plot(dist,SP_LF,c_line,'DisplayName',legendVal);
    setAxesZoomConstraint(z,ax1,'x'); 
    ...
    ax2 = nexttile(2); grid on; hold on;
    legendVal = strcat('Raw',': ',string(t));
    plot(dist,SuspPosFR,c_dot,'MarkerSize',3,'DisplayName',legendVal);
    legendVal = strcat('Filtered',': ',string(t));
    plot(dist,SP_RF,c_line,'DisplayName',legendVal);
    setAxesZoomConstraint(z,ax2,'x');
    ylabel('Damper Position [mm]'); ylim([-3 8]);
    ...
    ax3 = nexttile(3); grid on; hold on;
    legendVal = strcat('Raw',': ',string(t));
    plot(dist,SuspPosRL,c_dot,'MarkerSize',3,'DisplayName',legendVal); 
    legendVal = strcat('Filtered',': ',string(t));
    plot(dist,SP_LR,c_line,'DisplayName',legendVal);
    setAxesZoomConstraint(z,ax3,'x');
    ...
    legendVal = strcat('Raw',': ',string(t));
    plot(dist,SuspPosRR,c_dot,'MarkerSize',3,'DisplayName',legendVal); 
    legendVal = strcat('Filtered',': ',string(t));
    plot(dist,SP_RR,c_line,'DisplayName',legendVal);
    setAxesZoomConstraint(z,ax4,'x');
    ylabel('Damper Position [mm]'); ylim([-7 1]);
